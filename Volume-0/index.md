...
Le Volume 0 définit les règles normatives applicables à l’ensemble de la collection et du Companion Pack.

## Chapitres

1. [Vision générale du projet](CHAPITRE-01-Vision-generale-du-projet.md) — **rédigé et audité**
2. [Les 21 règles fondamentales](CHAPITRE-02-Les-21-regles-fondamentales.md) — **rédigé et audité**
3. [Architecture documentaire](CHAPITRE-03-Architecture-documentaire.md) — **rédigé et audité**
4. [Convention des identifiants](CHAPITRE-04-Convention-des-identifiants.md) — **rédigé et audité**
5. [Conventions Markdown et Pandoc](CHAPITRE-05-Conventions-Markdown-et-Pandoc.md) — **rédigé et audité**
6. [Style rédactionnel](CHAPITRE-06-Style-redactionnel.md) — **rédigé et audité**
7. [Standards techniques](CHAPITRE-07-Standards-techniques.md) — **rédigé et audité**
8. [Standards IA](CHAPITRE-08-Standards-IA.md) — **rédigé et audité**
9. [Politique de compatibilité](CHAPITRE-09-Politique-de-compatibilite.md) — **rédigé et audité**
10. [Production, validation et publication](CHAPITRE-10-Production-validation-et-publication.md) — **rédigé et audité**
11. [Glossaire, bibliographie et index](CHAPITRE-11-Glossaire-bibliographie-et-index.md) — **rédigé et audité**
...
Le milestone **M1 — Volume 0 : Fondation documentaire** est terminé. Les onze chapitres principaux, les huit annexes normatives, le référentiel QA et la chaîne de compilation multiplateforme ont été validés. La licence globale reste à définir avant une publication officielle de la collection.
