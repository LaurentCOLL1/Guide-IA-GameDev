...
- **Invariants protégés :** `revision` permet de refuser une commande construite depuis un état obsolète.
...
- **Limites et réserves :** Aucun dépôt actif n’est modifié pendant le décodage.
