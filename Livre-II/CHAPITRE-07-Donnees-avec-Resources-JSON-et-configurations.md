...
Le chapitre 28 généralisera la journalisation et la reproductibilité.
...
Ajouter son chemin à `BeaconCatalogPaths.PATHS`.
...
**Symptôme :** plusieurs instances changent en même temps.

**Correction :** séparer définition et état runtime ou dupliquer explicitement.

### 35.2 Utiliser le nom affiché comme identifiant

**Symptôme :** une traduction casse les références.

**Correction :** utiliser un identifiant technique stable indépendant de l’affichage.

### 35.3 Accepter tout JSON syntaxiquement valide

**Symptôme :** erreur plus tard dans le gameplay.

**Correction :** contrôler racine, champs, types, plages, doublons et version.

### 35.4 Lire un fichier texte avec `ResourceLoader`

**Symptôme :** chargement impossible d’un JSON non importé comme ressource.

**Correction :** utiliser `FileAccess` puis `JSON`.

### 35.5 Enregistrer l’état du joueur dans une `.tres` de conception

**Symptôme :** données sources modifiées ou écriture impossible dans un export.

**Correction :** attendre le système de sauvegarde versionné du chapitre 9.

### 35.6 Mettre un secret dans `default.cfg`

**Symptôme :** secret présent dans Git.

**Correction :** utiliser un mécanisme externe sécurisé et documenté.

### 35.7 Parcourir un dossier sans trier ni valider

**Symptôme :** ordre différent selon les systèmes et erreurs difficiles à reproduire.

**Correction :** liste explicite ou tri déterministe, identifiants stables et rapport d’import.

### 35.8 Propager des dictionnaires partout

**Symptôme :** clés magiques et erreurs tardives.

**Correction :** convertir à la frontière vers des classes ou `Resource` typées.
