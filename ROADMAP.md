...
- [x] Chapitre 17 — Publication et distribution — rédigé, repéré et audité au niveau `static-review`.
...
- [x] Chapitre 22 — Maintenance, archivage et pérennité — rédigé, repéré et audité au niveau `static-review`.
...
**Statut M7 : actif — 7 packs validés sur 10 ; Pack 8, Test & Benchmark Library, suivant.**
...
- [x] ComfyUI Library — version `1.0.0`, validation Linux `runtime-tested` avec ComfyUI CPU sans modèle.
